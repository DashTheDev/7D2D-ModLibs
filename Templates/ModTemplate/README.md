# ModTemplate
A [7 Days to Die](https://store.steampowered.com/app/251570/7_Days_to_Die/) mod.

## Installation
Download the [latest release](https://RELEASE_LINK_HERE.com), unzip and drop the `ModTemplate` folder into your game's `Mods` directory.
